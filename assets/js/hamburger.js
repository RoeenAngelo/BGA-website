...
let ro = new Player('Ro', 54, 44.2)
let kyle = new Player('Kyle', 37.167, 101.333)
let george = new Player('George', 162.5, 101.333)
let des = new Player('Des', 67.5, 230)
let ed = new Player('Ed', 51, 58)
let pat = new Player('Pat', 100, 101.333)
let dayza = new Player('Dayza', 77.5, 230)
let chris = new Player('Chris', 58.5, 74.5)
let aaron = new Player('Aaron', 500, 66)
let justin = new Player('Justin', 87.5, 600)
let tim = new Player('Tim', 37.167, 85)
let sam = new Player('Sam', 77.5, 120)
let arvin = new Player('Arvin', 87.5, 85)
let galvin = new Player('Galvin', 47, 51)
let ezra = new Player('Ezra', 37.167, 54)
let alan = new Player('Alan', 49, 54)
let niehmer = new Player('Niehmer', 162.5, 41.078)
let morris = new Player('Morris', 300, 230)
let jordan = new Player('Jordan', 58.5, 61)
let daniel = new Player('Daniel Lee', 67.5, 66)
let james = new Player('James', 45, 74.5)
let jason = new Player('Jason', 54, 46.467)
let ronald = new Player('Ronald', 41, 41.078)
let aldrich = new Player('Aldrich', 43, 48.733)
let joe = new Player('Joe', 110, 58)
