...
let des = new Player('Des', 0, 0)
let ed = new Player('Ed', 0, 0)
let pat = new Player('Pat', 0, 0)
let dayza = new Player('Dayza', 0, 0)
let chris = new Player('Chris', 0, 0)
let aaron = new Player('Aaron', 0, 0)
let justin = new Player('Justin', 0, 0)
let tim = new Player('Tim', 0, 0)
let sam = new Player('Sam', 0, 0)
let arvin = new Player('Arvin', 0, 0)
let galvin = new Player('Galvin', 0, 0)
let ezra = new Player('Ezra', 0, 0)
let alan = new Player('Alan', 0, 0)
let niehmer = new Player('Niehmer', 0, 0)
let morris = new Player('Morris', 0, 0)
let jordan = new Player('Jordan', 0, 0)
let daniel = new Player('Daniel Lee', 0, 0)
let james = new Player('James', 0, 0)
let jason = new Player('Jason', 0, 0)
