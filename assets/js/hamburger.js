...
let ro = new Player('Ro',  152.2, 53)
let kyle = new Player('Kyle', 186.5, 43.056)
let george = new Player('George', 348.8, 109.167)
let des = new Player('Des', 365.0, 115)
let ed = new Player('Ed', 231.5, 43.056)
let pat = new Player('Pat', 255.3, 83.611)
let dayza = new Player('Dayza', 392.5, 167.5)
let chris = new Player('Chris', 233.0, 500)
let aaron = new Player('Aaron', 633.5, 43.05)
let justin = new Player('Justin', 738.5, 55)
let tim = new Player('Tim', 189.7, 91.111)
let sam = new Player('Sam', 242.5, 58)
let arvin = new Player('Arvin', 257.5, 74.167)
let galvin = new Player('Galvin', 155.0, 300)
let ezra = new Player('Ezra', 158.7, 115)
let alan = new Player('Alan', 225.5, 43.056	)
let niehmer = new Player('Niehmer', 448.6, 71.67)
let morris = new Player('Morris', 571.0, 43.05)
let jordan = new Player('Jordan', 162.5, 43.056)
let daniel = new Player('Daniel Lee', 633.5, 43.05)
let james = new Player('James', 155.0, 59)
let jason = new Player('Jason', 139.5, 43.056)
let ronald = new Player('Ronald', 119.1, 43.056)
let aldrich = new Player('Aldrich', 336.7, 101.945)
let joe = new Player('Joe', 216.0, 70.833)
